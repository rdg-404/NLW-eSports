          ...
          <Dialog.Content className="fixed bg-[#2a2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/50" >
            ...
            <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input name="name" id="name" placeholder="Como te chamam nos games" />
              </div>

              <div className="grid grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label htmlFor="yearsPlaying">Joga há quantos anos</label>
                  <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder="Há quanto tempo você joga"/>
                </div>
                <div className="flex flex-col gap-2">
              ...
              <label className="mt-2 flex items-center gap-2 text-sm">
                <Checkbox.Root 
                  ...
                  className="w-6 h-6 p-1 rounded bg-zinc-900 flex "
                >
                  <Checkbox.Indicator>
              ...
              {/* PARA FECHAR O POP-UP AO CLICAR EM CANCELAR*/}
                <Dialog.Close 
                  type="button"
